    ...
    <div class="col-md-12">
        <nav aria-label="breadcrumb" class="float-right mt-1">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/doctor/list">Danh sách Bệnh nhân</a></li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="/doctor/add" method="POST" enctype="multipart/form-data">           
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="simpleinput" name="doctor_name" value="" placeholder="Họ và tên...">
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="file"  class="form-control" name="doctor_image" id="example-fileinput">
                                </div>
                            </div>
