    ...
    <div class="col-md-12">
        <nav aria-label="breadcrumb" class="float-right mt-1">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="/patient/list">Danh sách Bệnh nhân</a></li>
                <li class="breadcrumb-item active" aria-current="page">Thêm Bệnh nhân</li>
            </ol>
        </nav>
        <h4 class="mb-1 mt-0">Thêm Bệnh nhân</h4>
    </div>
</div>
@endsection
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" action="{{route('patient.add')}}" method="POST" enctype="multipart/form-data">             
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="simpleinput" name="patient_name" value="" placeholder="Họ và tên...">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Giới tính" class="form-control" name="sex" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Dân tộc" class="form-control" name="ethnic" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Nghề nghiệp" class="form-control" name="professional" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Cơ quan, đơn vị làm việc" class="form-control" name="company" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Địa chỉ" class="form-control" name="address" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Thôn, tổ" class="form-control" name="village" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Xã,phường thị trấn" class="form-control" name="wards" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Quận, huyện" class="form-control" name="district" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Tỉnh, thành phố" class="form-control" name="provincial" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="number" name="phone" class="form-control" placeholder="Số điện thoại" id="example-placeholder">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-textarea">Tóm tắt bệnh án</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="5" name="description" id="example-textarea"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="5" name="diagnosed_go_in_hospital" id="example-textarea"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="5" name="diagnosed_go_out_hospital" id="example-textarea"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="file"  name="patient_image" class="form-control" id="example-fileinput">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input class="form-control" name="date_start" id="example-date" type="date">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input class="form-control" name="date_end" id="example-date" type="date">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="5" name="pathological_process" id="example-textarea"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="5" name="test_result" id="example-textarea"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-textarea">Phương pháp điều trị</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="5" name="treatments" id="example-textarea"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="5" name="status" id="example-textarea"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-textarea">Ghi chú</label>
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="5" name="note" id="example-textarea"></textarea>
                                </div>
                            </div>
