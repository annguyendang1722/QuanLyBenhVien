    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif     
                <form class="form-horizontal" action="/doctor/edit/{{$doctor->id}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" id="simpleinput" name="doctor_name" value="{{$doctor->doctor_name}}" placeholder="Họ và tên...">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-email">Email</label>
                                <div class="col-lg-10">
                                    <input type="email" id="example-email" name="email" value="{{$doctor->email}}" class="form-control" placeholder="Email">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-password">Địa chỉ</label>
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Địa chỉ" class="form-control" value="{{$doctor->address}}"  name="address" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Dân tộc" class="form-control" value="{{$doctor->ethnic}}"  name="ethnic" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Nghề nghiệp" class="form-control" value="{{$doctor->professional}}"  name="professional" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" placeholder="Giới tính" class="form-control" value="{{$doctor->sex}}"  name="sex" id="example-password">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="number" name="phone" value="{{$doctor->phone}}"  class="form-control" placeholder="Số điện thoại" id="example-placeholder">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" rows="5" name="description" id="example-textarea">{{$doctor->description}}</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <input type="file" name="doctor_image" class="form-control" id="example-fileinput">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-lg-2 col-form-label" for="example-date">Lịch Khám</label>
                                <div class="col-lg-10">
